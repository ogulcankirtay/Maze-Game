...
public class Mantarsinifi extends Obje {

    public Mantarsinifi() {
    }

    public Mantarsinifi(String objectype, int timer, int visbltytime, int price, int objLocationx, int objLocationy, int numberOfObject) {
